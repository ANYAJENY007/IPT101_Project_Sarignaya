...
const translations = {
  en: {
    ...
    contactDescription: 'Get in touch with me for collaborations or just to say hello!',
    nameLabel: 'Name',
    emailLabel: 'Email',
  ...
  fil: {
    ...
    heroSubtitle: 'Full-Stack Developer & UI/UX Designer',
    heroDescription: 'Masigasig sa paglikha ng magagandang at functional na web experiences',
    ...
    contactDescription: 'Makipag-ugnayan sa akin para sa collaborations o para lang mag-hello!',
    nameLabel: 'Pangalan',
    emailLabel: 'Email',
